  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-[#FFFBF1] to-white pb-20">
      <section className="container-layout relative overflow-hidden py-20">
        ...
        <div className="mx-auto max-w-5xl rounded-[28px] border border-[#FBCC5C]/40 bg-white/85 px-10 py-16 text-center shadow-[0_28px_90px_rgba(251,204,92,0.35)] backdrop-blur">
          <div className="mx-auto flex max-w-3xl flex-col items-center gap-8">
            <div className="inline-flex items-center gap-3 rounded-full bg-[#FBCC5C]/20 px-7 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-[#2C2108] ring-1 ring-[#FBCC5C]">
      ...
      <section className="container-layout">
        <div className="grid items-center gap-10 rounded-[30px] bg-white p-8 shadow-[0_28px_100px_rgba(0,0,0,0.08)] lg:grid-cols-[1.25fr_1fr]">
          <div className="relative overflow-hidden rounded-3xl border border-[#FBCC5C]/50 bg-white p-8 shadow-[0_22px_70px_rgba(0,0,0,0.06)]">
            ...
            <div className="absolute right-6 top-6 rounded-full bg-white/85 px-3 py-1 text-xs font-semibold uppercase text-[#6B520B] ring-1 ring-[#FBCC5C]/60">
              {metadata.symbol}
            </div>

            <div className="mt-16 flex flex-col items-center gap-7">
              <div className="relative w-full max-w-lg overflow-hidden rounded-[26px] border border-[#FBCC5C]/45 bg-gradient-to-br from-white via-[#FFF8E4] to-white shadow-[0_18px_80px_rgba(0,0,0,0.09)]">
                <Image
              ...
              <div className="grid w-full gap-4 rounded-2xl bg-white p-5 text-left shadow-[0_12px_40px_rgba(0,0,0,0.06)] ring-1 ring-[#FBCC5C]/35 sm:grid-cols-2">
          ...
          <div className="flex h-full flex-col justify-between gap-8 rounded-3xl border border-[#FBCC5C]/60 bg-white px-8 py-9 shadow-[0_22px_70px_rgba(0,0,0,0.06)]">
